                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 3:
                                    _a.sent();
                                    device.play();
                                    return [4 /*yield*/, device.delay(ClientDevice.PING_HOLD)];
                                case 4:
                                    _a.sent();
                                    return [3 /*break*/, 2];
...
var ClientDevice = exports.ClientDevice = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.debug("PING");
                        this.stop_timeout();
                        return [4 /*yield*/, this.ping_once().then(function (res) { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
    ...
    ClientDevice.prototype.check_time = function (client_vitals, server_vitals) {
        return __awaiter(this, void 0, void 0, function () {
            var server_track_time, client_track_time, hold, difference;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(difference > ClientDevice.ADJUST_THRESHOLD ||
                            difference < -ClientDevice.ADJUST_THRESHOLD)) return [3 /*break*/, 4];
                        //adjust
                        console.log("ADJUSTING TIME", server_track_time);
                        if (!(server_track_time < hold)) return [3 /*break*/, 2];
                        console.log("DELAY", (hold - server_track_time) * 1000);
                        return [4 /*yield*/, this.delay((hold - server_track_time) * 1000)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, this.set_time(0)];
                    case 2:
                        console.log("NO DELAY", server_track_time, server_track_time - hold);
                        return [4 /*yield*/, this.set_time(server_track_time - hold)];
